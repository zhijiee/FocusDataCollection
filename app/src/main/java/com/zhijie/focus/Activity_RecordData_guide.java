 ...
 */
public class Activity_RecordData_guide extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeakReference<Activity_RecordData_guide> weakActivity =
                new WeakReference<Activity_RecordData_guide>(this);
    ...
    class MuseL extends MuseListener {
        final WeakReference<Activity_RecordData_guide> activityRef;

        MuseL(final WeakReference<Activity_RecordData_guide> activityRef) {
    ...
    class ConnectionListener extends MuseConnectionListener {
        ...
        ConnectionListener(final WeakReference<Activity_RecordData_guide> activityRef) {
            this.activityRef = activityRef;
        }
    ...
    class DataListener extends MuseDataListener {
        ...
        DataListener(final WeakReference<Activity_RecordData_guide> activityRef) {
            this.activityRef = activityRef;
        }
