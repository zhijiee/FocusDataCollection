...
//    public static final boolean USE_MUSE = true;
    ...
    public static final int ARITH_TRAINING_TIMEOUT = 15;
    public static final int GUIDED_MEDITATION_TRACK = R.raw.ting;
    public static final int ARITH_TEST_TIMEOUT = 100;
    public static final boolean USE_MUSE = false;

    public static final int cd_interval = 1;

    //Muse Stable Time in Milliseconds
    public static final int MUSE_STABLE_TIME = 5000;
    public static final int MUSE_STABLE_TIME_CD_INTERVAL = 100;
